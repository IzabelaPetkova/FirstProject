...
//Проверяваме с функцията isset дали променливата $_POST съществува и да не е празна
...
function login($db_u, $db_p)
{
    ...
    if (isset($_POST) && !empty($_POST)) {
        if (
            ...
            //Ако въведените стойности съвпадат с дефинираните да ни изпрати в welcome.php страницата
            if (
                $db_u === $_POST["username"] &&
                $db_p === $_POST["password"]
            ) {
                header("Location: welcome.php");
                //Ако не съвпадат въведените стойности да ни препрати към login.php
            } else {
    ...
    public function login()
    {
        if (isset($_POST) && !empty($_POST)) {
            if (
                ...
                //Ако въведените стойности съвпадат с дефинираните да ни изпрати в welcome.php страницата
                if (
                    //От този клас вземи потр име и парола и провери дали са равни на въведените
                    $this->db_username === $_POST["username"] &&
                    $this->db_password === $_POST["password"]
                ) {
                    header("Location: welcome.php");
                    //Ако не съвпадат въведените стойности да ни препрати към login.php
                } else {
